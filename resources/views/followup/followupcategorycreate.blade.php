      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('followupcategory.store') }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="days" id="required" value="{{ old('goal') }}">
                          @if ($errors->has('goal'))
