      ...
      <div class="span12">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>FollowupCategory</h5>
          <a href="{{ route ('followupcategory.create') }}" span class="label label-info"><i class="icon-plus icon-white"></i> Add New FollowupCategory</span> </a>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  <td>{{ $loop->index + 1 }}</td>
                  <td>{{ $followupcats->name }}</td>
                  <td>{{ $followupcats->days }}</td>
                  <td>{{ $followupcats->notes }}</td>
                   <td>
                    <li><a href="{{ url('followup/'.$followupcats->id.'/edit') }}"><i class="icon-pencil"></i>Edit</a></li>
                              <li><a href="{{ url('followup/'.$followupcats->id.'/delete') }}"><i class="icon-remove"></i>Delete</a></li>
                  </td>
                </tr>
                 @endforeach 
