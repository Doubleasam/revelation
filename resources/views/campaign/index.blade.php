    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <a href="{{ route ('campaign.create') }}" span class="label label-info"><i class="icon-plus icon-white"></i> Add New Campaign</span> </a>
          </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>{{ $campaigns->goal }}</td>
                  <td>{{ $campaigns->notes }}</td>
                   <td>
                    <li><a href="{{ url('member/'.$campaigns->id.'/show') }}"><i class="icon-eye-open"></i>Show</a></li>
                             <li><a href="{{ url('member/'.$campaigns->id.'/edit') }}"><i class="icon-pencil"></i>Edit</a></li>
                              <li><a href="{{ url('member/'.$campaigns->id.'/delete') }}"><i class="icon-remove"></i>Delete</a></li>
                  </td>
                </tr>
                 @endforeach 
