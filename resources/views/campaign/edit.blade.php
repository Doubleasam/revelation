...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href=".html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">campaign</a> <a href="#" class="current">Validation</a> </div>
  </div>
            ...
            <form class="form-horizontal" method="POST" action="{{ route ('member.update', $members->id) }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              ...
              {{method_field('PUT')}}
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select  name="gender" value="{{ $members->gender  }}" >
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select  name="status" value="{{ $members->status }}">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select  name="marital_status" value="{{ $members->marital_status }}">
