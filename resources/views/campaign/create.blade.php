...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href=".html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Form elements</a> <a href="#" class="current">Validation</a> </div>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('campaign.store') }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
                  <div class="control-group">
                    <label class="control-label">Name Of Campaign</label>
                    <div class="controls">
                  ...
                  <div class="control-group">
                    <label class="control-label">Goal Of Campaign</label>
                    <div class="controls">
                      <input type="text" name="goal" id="required" value="{{ old('goal') }}">
                          @if ($errors->has('goal'))
                                    <p class="alert alert-danger">{{ $errors->first('goal') }}
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="textfield" name="notes" id="required" value="{{ old('notes') }}">
                          @if ($errors->has('notes'))
