      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('contribution.store') }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
                    ...
                    <label class="control-label">Funds</label>
                      <div class="controls">
                        <select name="fund_id">
                          ...
                          <option value="{{ $funds->id }}">{{ $funds->name }}</option>
                          @endforeach
                        </select>
                      </div>
                  </div>
