...
<div id="header">
  <h1><img src="{{ asset('resources/assets/back/img/email.png') }}"/></h1>
</div><!-- <div class="header__logo emb-logo-margin-box" style="font-size: 26px; line-height: 32px; color: #c3ced9; font-family: Roboto,Tahoma,sans-serif; margin: 6px 20px 20px 20px;">
...
<p class="size-14" style="margin-top: 0px; margin-bottom: 0px; line-height: 21px;"><font size="3">Thanks,</font><br> <strong style="font-size: 14px;">Revelation Manager</strong></p>
</div>
</td>
</tr>
</tbody>
