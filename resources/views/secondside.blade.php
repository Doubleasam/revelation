<div id="sidebar"><a href="{{ url ('home') }}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu {{ Request::is ('member', 'member/create') ?  'active'  : '' }}"> <a href="{{ url ('#') }}"><i class="icon icon-signal"></i> <span>Members</span></a>
    ...
    <li class="submenu {{ Request::is ('pledge', 'pledge/create', 'campaign/create') ?  'active'  : '' }}"><a href="{{ url ('#') }}"><i class="icon icon-th"></i> <span>Pledges</span></a>
    <ul>
        <li><a href="{{ route ('pledge.index') }}">View Pledges</a></li>
        <li><a href="{{ route ('pledge.create') }} ">Add Pledges</a></li>
        <li><a href="{{ route ('campaign.create') }} ">Manage Campaigns</a></li>
    </ul>
    </li>
    <li class="submenu {{ Request::is ('contribution', 'contribution/create') ?  'active'  : '' }}"><a href="{{ url ('#') }}"><i class="icon icon-fullscreen"></i> <span>Contributions</span></a>
    <ul>
