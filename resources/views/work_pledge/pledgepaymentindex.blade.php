      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('pledge.store') }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
                      ...
                      <div class="controls">
                        <select name="member_id">
                           @foreach ($member as $members)
                            <option value="{{ $members->first_name }}">{{ $members->first_name }}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <label class="control-label">Campaign</label>
                      <div class="controls">
                        <select name="campaign_id">
                          ...
                          <option value="{{ $campaigns->name }}">{{ $campaigns->name }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
