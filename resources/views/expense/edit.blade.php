      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <form class="form-horizontal" method="POST" action="{{ route ('contribution.update', $contribution->id) }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
              {{method_field('PUT')}}
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="number" name="amount" id="required" value="{{ $contribution->amount }}">
                  ...
                  <div class="controls">
                    <div  data-date="2012-11-02" class="input-append date datepicker">
                      <input type="text"  name="date" value="2012-11-02"  data-date-format="yyyy-mm-dd" class="span11"  value="{{ $contribution->date }}">
                          @if ($errors->has('date'))
                    ...
                    <label class="control-label">Funds</label>
                      <div class="controls">
                        <select name="fund_id">
                          ...
                          <option value="{{ $contribution->fund_id }}">{{ $contribution->fund->name }}</option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="notes" id="required" value="{{ $contribution->notes }}">
                          @if ($errors->has('notes'))
