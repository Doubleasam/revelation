      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('expense.store') }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
                  <div class="control-group">
                      <label class="control-label">Expensetype</label>
                      <div class="controls">
                        <select name="expense_type_id">
                           @foreach ($expensetype as $expensetypes)
                            <option value="{{ $expensetypes->id }}">{{ $expensetypes->name }}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="file"  name="files"  value="{{ old('photo') }}">
                            @if ($errors->has('photo'))
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="span11" name="notes" id="required" value="{{ old('notes') }}">
                          @if ($errors->has('notes'))
