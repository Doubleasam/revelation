        ...
        <div class="widget-box">
         ...
         @foreach ($member  as $members)
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="{{ route ('member.update', $members->id) }}" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              {{ csrf_field() }}
              {{method_field('PUT')}}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="first_name" id="required" value="{{  $members->first_name }}">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="middle_name" id="required" value="{{ $members->middle_name }}">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="last_name" id="required" value="{{ $members->last_name}}">
              ...
              <div class="control-group">
                      ...
                      <div class="controls">
                        <select  name="gender">
                           <option value="Unknown"  {{ old('gender', $members->gender) == "Unknown" ? 'selected' : '' }}>
                             {{$members->gender}}
                          </option>
                          <option value="Male" {{ old('gender', $members->gender) == "Male" ? 'selected' : '' }}>
                              {{$members->gender}}
                          </option>
                          <option value="Female" {{ old('gender', $members->gender) == "Female" ? 'selected' : '' }}>
                              {{$members->gender}}
                          </option>
                        </select>
                      </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                      ...
                      <select  name="status">
                           <option value="Unknown"  {{ old('gender', $members->status) == "Unknown" ? 'selected' : '' }}>
                             {{$members->status}}
                          </option>
                          <option value="Attender" {{ old('gender', $members->status) == "Attender" ? 'selected' : '' }}>
                              {{$members->status}}
                          </option>
                          <option value="Visitor" {{ old('gender', $members->status) == "Visitor" ? 'selected' : '' }}>
                              {{$members->status}}
                          </option>
                          <option value="Inactive" {{ old('gender', $members->status) == "Inactive" ? 'selected' : '' }}>
                              {{$members->status}}
                          </option>
                        </select>
                  </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                     ...
                     <select  name="marital_status">
                           <option value="Unknown"  {{ old('gender', $members->marital_status) == "Unknown" ? 'selected' : '' }}>
                             {{$members->marital_status}}
                          </option>
                          <option value="Attender" {{ old('gender', $members->marital_status) == "Single" ? 'selected' : '' }}>
                              {{$members->marital_status}}
                          </option>
                          <option value="Visitor" {{ old('gender', $members->marital_status) == "Engaged" ? 'selected' : '' }}>
                              {{$members->marital_status}}
                          </option>
                          <option value="Inactive" {{ old('gender', $members->marital_status) == "Married" ? 'selected' : '' }}>
                              {{$members->marital_status}}
                          </option>
                        </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="mobile_phone" id="required" value="{{ $members->mobile_phone }}">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="email" id="required" value="{{ $members->email }}">
                        @if ($errors->has('email'))
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <div  data-date="2012-11-02" class="input-append date datepicker">
                      <input type="text"  name="dob" value="2012-11-02"  data-date-format="yyyy-mm-dd" class="span11"  value="{{ $members->dob }}">
                          @if ($errors->has('dob'))
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="address" id="required" value="{{ $members->address }}">
                  ...
                  <!-- <div class="control-group">
                    ...
                    <div class="control-group">
                      <label class="control-label">Photo</label>
                      <div class="controls">
                        <input type="file"  name="photo"  value="{{ $members->photo }}">
                            @if ($errors->has('photo'))
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="description" id="required" value="{{ $members->description }}">
